...
try:
	...
	time.sleep(0.5)
	Motor2.TurnStep(Dir='backward', steps=4000, stepdelay=0.001)
	Motor2.Stop()
	
	Motor1.SetMicroStep('hardware','fullstep')
	Motor1.TurnStep(Dir='forward', steps=1000, stepdelay = 0.0005)
	time.sleep(0.5)
	Motor1.TurnStep(Dir='backward', steps=2000, stepdelay = 0.0005)
	Motor1.Stop()
